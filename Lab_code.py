...
# Read the data set
df = pd.read_csv('Lab_input.csv', encoding="cp1252", na_values=['NA', '?'])
...
out=check_network(dropout= 0.08474537936271988, lr=0.8781425034294131, neuronPct=0.10736336549471959,neuronShrink=0.42689654875500166)
print(out)
